...
class Carousel{
    ...
    timelineLoop(children){
        ...
        let nextPic = () => {
            ...
            let currentAnimation = new Animation(current.style, 'transform', v => `translateX(${v}%)`, - 100 * position, -100 - 100 * position, 500, 0, linear, 0)
            let nextAnimation = new Animation(next.style, 'transform', v => `translateX(${v}%)`, 100 - 100 * nextPosition, - 100 * nextPosition, 500, 0, linear, 0)
